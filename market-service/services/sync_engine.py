...
def catch_up_sync(db):
    ...
    EXTRA_TICKERS = [
        ...
        # China A
        ('600519.SS', 'Kweichow Moutai', 'ASHARE'),
        ('300750.SZ', 'CATL', 'ASHARE'),
        ('000858.SZ', 'Wuliangye Yibin', 'ASHARE'),
        ('601318.SS', 'Ping An Insurance', 'ASHARE'),
        ('600036.SS', 'China Merchants Bank', 'ASHARE'),
        ('601012.SS', 'LONGi Green Energy', 'ASHARE'),
        ('002594.SZ', 'BYD Co.', 'ASHARE'),
        ('600276.SS', 'Jiangsu Hengrui Medicine', 'ASHARE'),
        ('000333.SZ', 'Midea Group', 'ASHARE'),
        ('601888.SS', 'China Tourism Group Duty Free', 'ASHARE'),
        ('603288.SS', 'Foshan Haitian Flavouring', 'ASHARE'),
        ('600030.SS', 'CITIC Securities', 'ASHARE'),
        ('600900.SS', 'China Yangtze Power', 'ASHARE'),
        ('601166.SS', 'Industrial Bank Co.', 'ASHARE'),
        ('300059.SZ', 'East Money Information', 'ASHARE'),
        ('002415.SZ', 'Hikvision', 'ASHARE'),
        ('600028.SS', 'Sinopec', 'ASHARE'),
        ('601088.SS', 'China Shenhua Energy', 'ASHARE'),
        ('000568.SZ', 'Luzhou Laojiao', 'ASHARE'),
        ('601998.SS', 'China CITIC Bank', 'ASHARE'),
        ('002714.SZ', 'Muyuan Foods', 'ASHARE'),
        ('601398.SS', 'ICBC', 'ASHARE'),
        ('601288.SS', 'Agricultural Bank of China', 'ASHARE'),
        ('601939.SS', 'China Construction Bank', 'ASHARE'),
        ('601988.SS', 'Bank of China', 'ASHARE'),
        ('600887.SS', 'Yili Group', 'ASHARE'),
        ('603259.SS', 'WuXi AppTec', 'ASHARE'),
        ('300015.SZ', 'Aier Eye Hospital', 'ASHARE'),
        ('300122.SZ', 'Chongqing Zhifei Biological', 'ASHARE'),
        ('300014.SZ', 'EVE Energy', 'ASHARE'),
        ('600309.SS', 'Wanhua Chemical', 'ASHARE'),
        ('000002.SZ', 'China Vanke Co.', 'ASHARE'),
        ('000001.SZ', 'Ping An Bank', 'ASHARE'),
        ('000166.SZ', 'Shenwan Hongyuan', 'ASHARE'),
        ('601628.SS', 'China Life Insurance', 'ASHARE'),
        ('601857.SS', 'PetroChina', 'ASHARE'),
        ('601668.SS', 'China State Construction', 'ASHARE'),
        ('601328.SS', 'Bank of Communications', 'ASHARE'),
        ('600016.SS', 'Minsheng Bank', 'ASHARE'),
        ('600000.SS', 'Shanghai Pudong Development Bank', 'ASHARE'),
        ('600048.SS', 'Poly Developments', 'ASHARE'),
        ('601818.SS', 'China Everbright Bank', 'ASHARE'),
        ('600104.SS', 'SAIC Motor', 'ASHARE'),
        ('601186.SS', 'China Railway Construction', 'ASHARE'),
        ('601766.SS', 'CRRC', 'ASHARE'),
        ('601006.SS', 'Daqin Railway', 'ASHARE'),
        ('601989.SS', 'China Shipbuilding Industry', 'ASHARE'),
        ('601800.SS', 'China Communications Construction', 'ASHARE'),
        ('601111.SS', 'Air China', 'ASHARE'),
        ('600019.SS', 'Baoshan Iron & Steel', 'ASHARE')
    ]
